...
public class Line8 extends AppCompatActivity {
    ...
    private Button line8[] = new Button[12];
    private Integer[] Rid_button = {
            R.id.station113_8, R.id.station801, R.id.station802, R.id.station803, R.id.station409_8, R.id.station608_8, R.id.station804, R.id.station805,
            R.id.station806, R.id.station705_8, R.id.station618_8, R.id.station214_8
    };
